            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="container mb-12 lg:mb-0">
                ...
                <p className="text-base leading-relaxed mb-9 text-body-color">
                  Não hesite em entrar em contato conosco se tiver dúvidas,
                  precisar de informações adicionais ou quiser agendar uma
                  consulta. Estamos aqui para ajudar e garantir que você receba
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">
                      Luanda, Av. 4 de Fevereiro (Marginal de Luanda)
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-baseDark transition border rounded border-primary bg-primary hover:bg-opacity-90"
                    >
                      Enviar mensagem
                    </button>
                  </div>
